 ...
 * @author Miroslav
 */
public class PretragaProizvoda extends OpstaSistemskaOperacija{
    ...
    public ServerskiTransferObjekat izvrsiOperaciju(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            transferObjekat.setPoruka("Sistem je pronasao proizvode po zadatim kriterijumima pretrage");
        } catch (Exception ex) {
            Logger.getLogger(PretragaProizvoda.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("Sistem nije pronasao proizvode po zadatim kriterijumima pretrage");
        }

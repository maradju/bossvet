 ...
 * @author Miroslav
 */
public class PretraziKlijente extends OpstaSistemskaOperacija{
    ...
    public ServerskiTransferObjekat izvrsiOperaciju(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            transferObjekat.setPoruka("Sistem je pronasao klijente po zadatim kriterijumima pretrage");
        } catch (Exception ex) {
            Logger.getLogger(PretraziKlijente.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("Sistem nije pronasao klijente po zadatim kriterijumima pretrage");
        }
